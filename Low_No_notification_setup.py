...
def run_low_notification_setup(Credentials):
    # Read files
    Old_file, Old_file_books, New_file, New_file_books, Low_notification_old_path = Low_Notification_Excel_Manage.read_low_files()
    ...
    new_cases, repeated_cases = Low_Notification_Excel_Manage.get_new_repeated(Old_file_books=Old_file_books, New_file_books=New_file_books)
